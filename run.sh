...
exec ./Engine/Binaries/Linux/UE4Server-Linux-Shipping FactoryGame -log -unattended ?listen -Port="$SERVERGAMEPORT" -BeaconPort="$SERVERBEACONPORT" -ServerQueryPort="$SERVERQUERYPORT" -multihome="$SERVERIP" "$@"
